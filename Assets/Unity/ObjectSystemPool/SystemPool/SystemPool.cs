...
{
    public static class SystemPool
    {
        /// <summary>
        ...
        public static void DestroyPool(GameObject gameObject)
        {
            ...
            {
#if DEBUG
                Debug.LogError($"{gameObject.name} was not spawned by Pool!");
#endif
            }
        }
        ...
        {
            var poolParent = new GameObject($"[SystemPool] {prefab.name}");
        ...
        private static async void DefaultDespawn(GameObject toDespawn, float delay = 0f)
        {
            ...
            {
#if DEBUG
                Debug.LogError($"{toDespawn.name} was not spawned by Pool and will be destroyed!");
#endif
